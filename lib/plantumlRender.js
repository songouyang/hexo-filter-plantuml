                    ...
                    switch (config.link) {
                        ...
                        case "inline":
                            ...
                            if(config.link === "inlineBase64"){
                                resolve("<img style='display: table-cell; margin-left: auto; margin-right: auto' class='not-gallery-item' src='data:image/svg+xml;base64," + new Buffer(text).toString("base64") + "'>");
            ...
            return new Promise((resolve, reject) => {
                (realUrl.startsWith("https") ? https : http).get(realUrl, response => {
                    ...
                    response.on('data', function(chunk) {
                        ...
                        if(config.link === "inlineBase64"){
                            resolve("<img style='display: table-cell; margin-left: auto; margin-right: auto' class='not-gallery-item' src='data:image/svg+xml;base64," + buffer.toString("base64") + "'>");
                        } else if(config.link === "inlineUrlEncode") {
